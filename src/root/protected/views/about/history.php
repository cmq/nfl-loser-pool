<div class="container">
    <h2>History</h2>
    <p>
        The Loser Pool has come a long way since its humble beginnings.  In order to understand where we are now,
        sometimes it's helpful to look at the past:
    </p>
    ...
    <p>
        ...
        <small><small><ul>
            ...
            <li>Payout Structure: <strong>1st place wins it all</strong></li>
            <li>Power Rankings: <strong>No</strong></li>
            <li>Set by System Tracking: <strong>No</strong></li>
            <li>Talk Messages: <strong>No</strong></li>
            <li>Bandwagon: <strong>No</strong></li>
            <li>Lock Time: <strong>N/A</strong></li>
        </ul></small></small>
    </p>
    ...
    <p>
        ...
        <small><small><ul>
            ...
            <li>Talk Messages: <strong>No</strong></li>
            <li>Bandwagon: <strong>No</strong></li>
            <li>Lock Time: <strong>Thursday, 6pm Central</strong></li>
        </ul></small></small>
    </p>
    ...
    <p>
        ...
        <small><small><ul>
            ...
            <li>Biggest Loser Pot: <strong>No</strong></li>
            <li>Payout Structure: <strong>2nd place returns entry fee; 1st place gets the rest; pots are split 50/50</strong></li>
            <li>Power Rankings: <strong>No</strong></li>
            <li>Set by System Tracking: <strong>No</strong></li>
            <li>Talk Messages: <strong>No</strong></li>
            <li>Bandwagon: <strong>No</strong></li>
    ...
    <p>
        ...
        <small><small><ul>
            ...
            <li>Best Record Pot: <strong>Yes</strong></li>
            <li>Biggest Loser Pot: <strong>No</strong></li>
            <li>Payout Structure: <strong>Players finishing in 1st get twice as much as players finishing 2nd; pots are split 50/50</strong></li>
            <li>Power Rankings: <strong>No</strong></li>
