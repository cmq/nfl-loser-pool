<div class="container">
    <h2>Overview</h2>
    Welcome to the NFL Loser Pool.  This pool has been running since <?php echo param('earliestYear');?>.  Over the
    years there have been many bells and whistles added, but at the end of the day, the Loser Pool is about one thing
    only:<br />
    <br />
