...
<div class="container">
    <h2>Correct Week: <?php echo getWeekName($week);?></h2>
    <table class="table">
        <tr>
            <th colspan="2" style="text-align:center;"><span class="saved-status"></span></th>
        </tr>
        <tr>
            <th>User Picks</th>
            ...
            <td valign="top">
                <table border="0" cellspacing="1" cellpadding="2">
                    <tr class="tableHeads">
                        <th>Team</th>
                        <th>MOV</th>
    		            <?php echo ($bShowScores ? '<td>Score</td><td><button type="button" class="btn btn-primary applymovall">Apply All</button></td>' : ''); ?>
                    </tr>
                    <?
                    foreach ($teams as $team) {
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="mov form-control" teamid="<?php echo $team->id?>" value="<?php echo $thisMov ? $thisMov->mov : 0?>" />
                            </td>
                            <?php 
                            if ($bShowScores) {
                                $thisGame = null;
                                ...
                                if ($thisGame) {
                                    ...
                                    echo '</td><td>';
                                    if ($isFinal) {
                                        echo '<button type="button" class="btn btn-default applymov" mov="' . $mov . '" teamid="' . $team->id . '">Apply ' . $mov . '</button>';
                                    }
                                    echo '</td>';
                                } else {
                                    echo '<td>&nbsp;</td><td>&nbsp;</td>';
