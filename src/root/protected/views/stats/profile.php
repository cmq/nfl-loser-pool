        ...
        <div class="panel-body">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-4">Current Power Rank (<a title="Current Power Rank" data-content="The player's current power rank" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                        ...
                        <div class="col-xs-12 col-md-4">Current Power Points (<a title="Current Power Points" data-content="The total &quot;score&quot;, or number of points, which is used to calculate the Power Rank of each player" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                        <div class="col-xs-1 text-right"><strong><?php echo ($currentPower ? number_format($currentPower['powerpoints'], 3) : 'N/A');?></strong></div>
                        <?php
                        if ($currentPower) {
                            ?>
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for Seasons Played (<a title="Points for Seasons Played" data-content="Points earned for each season in which the player participated" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            <div class="col-xs-1 text-right"><?php echo $currentPower['seasonPts'];?></div>
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for First Place Trophies (<a title="Points for First Place Trophies" data-content="Points earned for finishing in First Place in any of the pots" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            <div class="col-xs-1 text-right"><?php echo $currentPower['firstPlacePts'];?></div>
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for Second Place Trophies (<a title="Points for Second Place Trophies" data-content="Points earned for finishing in Second Place in any of the pots" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            <div class="col-xs-1 text-right"><?php echo $currentPower['secondPlacePts'];?></div>
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for Money Won (<a title="Points for Money Won" data-content="Points earned for the amount of cash won by playing" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            <div class="col-xs-1 text-right"><?php echo $currentPower['moneyPts'];?></div>
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for Correct Picks (<a title="Points for Correct Picks" data-content="Points earned simply for getting picks correct" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            ...
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for Margin of Defeat (<a title="Points for Margin of Defeat" data-content="Points earned based on the player's average Margin of Defeat for all picks" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            <div class="col-xs-1 text-right"><?php echo $currentPower['movPts'];?></div>
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for Picks Set by System (<a title="Points for Picks Set by System" data-content="Points lost when the player fails to make a pick before the lock time, and lets the system pick for them." href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            <div class="col-xs-1 text-right"><?php echo $currentPower['setBySystemPts'];?></div>
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for Messages Posted (<a title="Points for Messages Posted" data-content="Points earned by simply posting chat messages" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            <div class="col-xs-1 text-right"><?php echo $currentPower['talkPts'];?></div>
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for "Likes" Given (<a title="Points for &quot;Likes&quot; Given" data-content="Points earned by &quot;Liking&quot; other players' messages" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            <div class="col-xs-1 text-right"><?php echo $currentPower['likesByPts'];?></div>
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for "Likes" Received (<a title="Points for &quot;Likes&quot; Received" data-content="Points earned by having other players &quot;Like&quot; this player's messages" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            ...
                            <div class="col-xs-11 col-xs-offset-1 col-md-3">Points for Badges Held (<a title="Points for Badges Held" data-content="Points earned for badges the user currently posseses.  Not all badges are worth points, but many are.  See the about page for more information." href="#" class="stat-help-link spawns-popover">?</a>)</div>
                            <div class="col-xs-1 text-right"><?php echo $currentPower['badgePts'];?></div>
                            <?php
                        }
                        ?>
                        <div class="col-xs-12 col-md-4">Highest Power Rank (<a title="Highest Power Rank" data-content="The highest (best) Power Rank ever achieved by the player at the end of any season (or the current spot in the current season)" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                        ...
                        <div class="col-xs-12 col-md-4">Lowest Power Rank (<a title="Lowest Power Rank" data-content="The lowest (worst) Power Rank ever achieved by the player at the end of any season (or the current spot in the current season)" href="#" class="stat-help-link spawns-popover">?</a>)</div>
                        ...
                        <div class="col-xs-12 col-md-4">Average Power Rank (<a title="Average Power Rank" data-content="The average Power Rank of the player at the end of all seasons since their first" href="#" class="stat-help-link spawns-popover">?</a>)</div>
