 ...
 */
alter table user add admin tinyint(1) not null default 0;
alter table user add superadmin tinyint(1) not null default 0;
...
alter table user add timezone int not null default 0;
alter table user add use_dst tinyint(1) not null default 1;

alter table loserpick add created datetime null;
alter table loserpick add updated datetime null;

alter table user add collapse_history tinyint(1) not null default 0;
alter table user add show_badges tinyint(1) not null default 1;
alter table user add show_logos tinyint(1) not null default 1;
alter table user add show_mov tinyint(1) not null default 1;

alter table losertalk add admin tinyint(1) not null default 0;

alter table userbadge add yr int null;
...
alter table winners add detail varchar(255) null;
update winners set detail = 'Week 9' where pot = 1 and place = 1 and yr = 2004;
update winners set detail = 'Perfect Season' where pot = 1 and place = 1 and yr = 2005;
update winners set detail = 'Week 20 (Conf Champ)' where pot = 1 and place = 2 and yr = 2005;
update winners set detail = '21-0' where pot = 2 and place = 1 and yr = 2005;
update winners set detail = '20-1' where pot = 2 and place = 2 and yr = 2005;
update winners set detail = 'Week 11' where pot = 1 and place = 1 and yr = 2006;
update winners set detail = 'Week 10' where pot = 1 and place = 2 and yr = 2006;
update winners set detail = '19-2' where pot = 2 and place = 1 and yr = 2006;
update winners set detail = '18-3' where pot = 2 and place = 2 and yr = 2006;
update winners set detail = 'Week 21 (Superbowl)' where pot = 1 and place = 1 and yr = 2007;
update winners set detail = 'Week 19 (Divisional)' where pot = 1 and place = 2 and yr = 2007;
update winners set detail = '20-1' where pot = 2 and place = 1 and yr = 2007;
update winners set detail = '19-2' where pot = 2 and place = 2 and yr = 2007;
update winners set detail = 'Week 16' where pot = 1 and place = 1 and yr = 2008;
update winners set detail = 'Week 6' where pot = 1 and place = 2 and yr = 2008;
update winners set detail = '19-2' where pot = 2 and place = 1 and yr = 2008;
update winners set detail = '18-3' where pot = 2 and place = 2 and yr = 2008;
update winners set detail = 'Perfect Season' where pot = 1 and place = 1 and yr = 2009;
update winners set detail = 'Week 18 (Wild Card)' where pot = 1 and place = 2 and yr = 2009;
update winners set detail = '21-0' where pot = 2 and place = 1 and yr = 2009;
update winners set detail = '19-2' where pot = 2 and place = 2 and yr = 2009;
update winners set detail = 'Week 10' where pot = 1 and place = 1 and yr = 2010;
update winners set detail = 'Week 9' where pot = 1 and place = 2 and yr = 2010;
update winners set detail = '19-2' where pot = 2 and place = 1 and yr = 2010;
update winners set detail = '18-3' where pot = 2 and place = 2 and yr = 2010;
update winners set detail = 'Week 10' where pot = 1 and place = 1 and yr = 2011;
update winners set detail = 'Week 9' where pot = 1 and place = 2 and yr = 2011;
update winners set detail = '20-1' where pot = 2 and place = 1 and yr = 2011;
update winners set detail = '19-2' where pot = 2 and place = 2 and yr = 2011;
update winners set detail = 'Week 19' where pot = 1 and place = 1 and yr = 2012;
update winners set detail = 'Week 6' where pot = 1 and place = 2 and yr = 2012;
update winners set detail = '20-1' where pot = 2 and place = 1 and yr = 2012;
update winners set detail = '19-2' where pot = 2 and place = 2 and yr = 2012;
update winners set detail = 'Week 18 (Wild Card)' where pot = 1 and place = 1 and yr = 2013;
update winners set detail = 'Week 15' where pot = 1 and place = 2 and yr = 2013;
update winners set detail = '19-2' where pot = 2 and place = 1 and yr = 2013;
update winners set detail = '18-3' where pot = 2 and place = 2 and yr = 2013;
